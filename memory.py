...
# для перемішування варіантів відповідей
...
questions_list.append(Question("Що це за Покемон?", "Пікачу", "Бульбазавр", "Поніта", "Чарізард"))
...
questions_list.append( Question("Яка популярна мова?", "Англ", "Українська", "Іспанська", "Франц") )
...
def check_answer():
    ...
    if answers[0].isChecked(): # перша кнопка — правильна (після shuffle)
        ...
        print("Пройшли запитань", window.total, "Кількість балів", window.score)
...
def next_question():
    ...
    cur_question = randint(0, len(questions_list)-1 )
                           ...
                           # Збільшуємо індекс питання


    # Якщо дійшли до кінця списку — починаємо с
